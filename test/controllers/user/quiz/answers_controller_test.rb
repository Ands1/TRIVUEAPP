...
class User::Quiz::AnswersControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create user_quiz_answer" do
    assert_difference('User::Quiz::Answer.count') do
      post user_quiz_answers_url, params: { user_quiz_answer: {  } }
    end

    assert_redirected_to user_quiz_answer_url(User::Quiz::Answer.last)
  end
  ...
  test "should destroy user_quiz_answer" do
    assert_difference('User::Quiz::Answer.count', -1) do
